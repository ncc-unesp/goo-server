...
project = u'Goo Arquitecture Overview'
...
htmlhelp_basename = 'goo-architecture'
...
latex_documents = [
  ('index', 'goo-architecture.tex', u'G Architecture Overview',
   u'NCC - UNESP', 'manual'),
]
...
man_pages = [
    ('index', 'goo-architecture', u'Goo Architecture Overview',
     [u'NCC - UNESP'], 1)
]
...
texinfo_documents = [
  ('index', 'goo-architecture', u'Goo Architecture Overview',
   u'NCC - UNESP', 'goo-architecture', u'Goo Architecture Overview',
   'Miscellaneous'),
]
