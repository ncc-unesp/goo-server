...
htmlhelp_basename = 'goo-serverapidoc'
...
latex_documents = [
  ('index', 'goo-serverapi.tex', u'goo-server api Documentation',
   u'NCC - UNESP', 'manual'),
]
...
texinfo_documents = [
  ('index', 'goo-serverapi', u'goo-server api Documentation',
   u'NCC - UNESP', 'goo-serverapi', 'One line description of project.',
   'Miscellaneous'),
]
