...
htmlhelp_basename = 'goo-developerguide'
...
latex_documents = [
  ('index', 'goo-developerguide.tex', u'Goo Developer Guide',
   u'NCC - UNESP', 'manual'),
]
...
man_pages = [
    ('index', 'goo-developerguide', u'Goo Developer Guide',
     [u'NCC - UNESP'], 1)
]
...
texinfo_documents = [
  ('index', 'goo-developerguide', u'Goo Developer Guide',
   u'NCC - UNESP', 'goo-developerguide', 'One line description of project.',
   'Miscellaneous'),
]
