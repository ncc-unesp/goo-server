...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.notify'
        db.delete_column('core_job', 'notify')


        # Changing field 'Job.return_code'
        db.alter_column('core_job', 'return_code', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Job.eta'
        db.alter_column('core_job', 'eta', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Adding field 'Job.notify'
        db.add_column('core_job', 'notify',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Job.return_code'
        db.alter_column('core_job', 'return_code', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Job.eta'
        db.alter_column('core_job', 'eta', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))
