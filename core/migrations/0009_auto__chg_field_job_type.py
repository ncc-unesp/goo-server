...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.type'
        db.alter_column('core_job', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Type']))

    def backwards(self, orm):

        # Changing field 'Job.type'
        db.alter_column('core_job', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Version']))
