...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.checkpoing_obj_id'
        db.delete_column('core_job', 'checkpoing_obj_id')
    ...
    def backwards(self, orm):
        # Adding field 'Job.checkpoing_obj_id'
        db.add_column('core_job', 'checkpoing_obj_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)
    ...
    models = {
        ...
        'core.job': {
            ...
            'checkpoint_obj_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
