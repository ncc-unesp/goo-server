...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.pilot'
        db.add_column('core_job', 'pilot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dispatcher.Pilot'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.pilot'
        db.delete_column('core_job', 'pilot_id')
