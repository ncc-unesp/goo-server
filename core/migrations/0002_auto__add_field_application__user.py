...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application._user'
        db.add_column(u'core_application', '_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application._user'
        db.delete_column(u'core_application', '_user_id')
    ...
    models = {
        ...
        u'core.job': {
            ...
            'checkpoints': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'cores_per_host': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 13, 0, 0)'}),
            'diskspace': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2048'}),
