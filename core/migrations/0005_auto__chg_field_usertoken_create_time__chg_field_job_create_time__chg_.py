...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserToken.create_time'
        db.alter_column('core_usertoken', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        ...
        # Changing field 'Job.modification_time'
        db.alter_column('core_job', 'modification_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserToken.create_time'
        db.alter_column('core_usertoken', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Job.create_time'
        db.alter_column('core_job', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Job.modification_time'
        db.alter_column('core_job', 'modification_time', self.gf('django.db.models.fields.DateTimeField')())
