...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.start_time'
        db.alter_column('core_job', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Job.end_time'
        db.alter_column('core_job', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Job.start_time'
        db.alter_column('core_job', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Job.end_time'
        db.alter_column('core_job', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=None))
