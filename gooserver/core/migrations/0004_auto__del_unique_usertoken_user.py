...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserToken', fields ['user']
        db.delete_unique('core_usertoken', ['user_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'UserToken', fields ['user']
        db.create_unique('core_usertoken', ['user_id'])
